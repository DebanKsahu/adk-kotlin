...
class ContextCacheConfigTest {
  ...
  @Test
  fun construct_cacheIntervalsTooLow_throwsIllegalArgumentException() {
    assertFailsWith<IllegalArgumentException> { ContextCacheConfig(cacheIntervals = 0) }
  }

  @Test
  fun construct_cacheIntervalsTooHigh_throwsIllegalArgumentException() {
    assertFailsWith<IllegalArgumentException> { ContextCacheConfig(cacheIntervals = 101) }
  }
